# Deployment di Llama, Ollama e Open WebUI in cluster kubernetes

## Descrizione del progetto

Il progetto consiste nel deployment di LLama  di un servizio **RAG (Retrieval-Augmented Generation)** di tipo biomedicale all’interno di un cluster Kubernetes, rendendolo accessibile tramite un'interfaccia web.  
